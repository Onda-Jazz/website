...
"use strict";var Contact=require("../components/contact"),Shows=require("../components/shows"),SongPlayer=require("../components/song_player"),React=require("react");window.React=React;var siteUrl=document.getElementsByTagName("html")[0].getAttribute("data-siteUrl");!function(){var e=document.getElementById("contactLink");e&&React.renderComponent(Contact({},e.innerHTML),e)}(),function(){var e=document.getElementById("shows");e&&React.renderComponent(Shows({siteUrl:siteUrl,shows:window.shows||[]}),e)}(),function(){var e=document.getElementById("songPlayer");e&&window.songs&&React.renderComponent(SongPlayer({siteUrl:siteUrl,tracks:window.songs}),e)}();
},{"../components/contact":2,"../components/shows":4,"../components/song_player":5,"react":144}],2:[function(require,module,exports){
"use strict";var React=require("react"),ContactLink=React.createClass({displayName:"ContactLink",getDefaultProps:function(){return{email:"booking@ondaband.com"}},onClick:function(){return"undefined"!=typeof window._gaq&&window._gaq.push(["_trackEvent","Contact","Send Email"]),!0},render:function(){return React.DOM.a({href:"mailto:"+this.props.email,onClick:this.onClick},this.props.children)}});module.exports=ContactLink;
},{"react":144}],3:[function(require,module,exports){
"use strict";var React=require("react"),PageLink=React.createClass({displayName:"PageLink",navigate:function(){return this.props.enabled?(this.props.callback(this.props.page),!1):!1},render:function(){return this.props.enabled?React.DOM.a({className:"nav",href:"#",onClick:this.navigate},this.props.children):React.DOM.a({className:"disabled-nav",onClick:this.navigate},this.props.children)}}),PaginationMixin={propTypes:{pageSize:React.PropTypes.number.isRequired,showBefore:React.PropTypes.number,showAfter:React.PropTypes.number},getInitialState:function(){return{page:0}},getPagination:function(e){var a=[],t=Math.ceil(e.length/this.props.pageSize);if(this.props.pageSize<=0)return null;a.push(new PageLink({page:0,enabled:0!==this.state.page,callback:this.navigate,key:"<<"},"first")),a.push(new PageLink({page:Math.max(0,this.state.page-1),enabled:0!==this.state.page,callback:this.navigate,key:"<"},"prev"));for(var i="number"==typeof this.props.showBefore?this.props.showBefore:3,s="number"==typeof this.props.showAfter?this.props.showAfter:3,n=Math.max(0,this.state.page-i);n<=this.state.page+s&&t>n;++n)a.push(n===this.state.page?React.DOM.a({key:"current",className:"currentPage"},"Page ",n+1," of ",t):new PageLink({page:n,enabled:!0,callback:this.navigate,key:n},String(n+1)));return a.push(new PageLink({page:Math.min(this.state.page+1,t-1),enabled:this.state.page!==t-1,callback:this.navigate,key:">"},"next")),a.push(new PageLink({page:t-1,enabled:this.state.page!==t-1,callback:this.navigate,key:">>"},"last")),a.length>0&&React.DOM.span({className:"pageLinks"},a)},paginate:function(e){if(this.props.pageSize<1)return e;var a=this.state.page*this.props.pageSize,t=Math.min(e.length,a+this.props.pageSize);return e.slice(a,t)},navigate:function(e){this.setState({page:e}),"undefined"!=typeof window._gaq&&(window._gaq.push(["_setCustomVar",1,"Page",String(e)]),window._gaq.push(["_trackEvent","Navigate","Page"]))}};module.exports=PaginationMixin;
},{"react":144}],4:[function(require,module,exports){
"use strict";var moment=require("moment-timezone"),React=require("react"),PaginationMixin=require("./pagination_mixin"),ShowDetail=React.createClass({displayName:"ShowDetail",getDefaultProps:function(){return{}},render:function(){return React.DOM.div({className:"show-detail",dangerouslySetInnerHTML:{__html:this.props.content}})}}),ShowInfo=React.createClass({displayName:"ShowInfo",getDefaultProps:function(){return{}},getInitialState:function(){return{detail:!1}},display:function(){var t=!this.state.detail;return this.setState({detail:t}),"undefined"!=typeof window._gaq&&window._gaq.push(["_trackEvent","Shows",t?"View Detail":"Hide Detail",this.props.url]),!1},render:function(){var t=!!String(this.props.content).trim();return t?React.DOM.div(null,React.DOM.a({href:this.props.url,onClick:this.display},React.DOM.span(null,this.props.title||this.props.venue," ",React.DOM.span({className:"show-date"},this.props.moment.format("dddd, MMMM D, YYYY"),this.props.time&&" | "+this.props.time))),this.state.detail&&ShowDetail(this.props)):React.DOM.span(null,this.props.title||this.props.venue," ",React.DOM.span({className:"show-date"},this.props.moment.format("dddd, MMMM D, YYYY"),this.props.time&&" | "+this.props.time))}}),Show=React.createClass({displayName:"Show",render:function(){return React.DOM.li(null,React.DOM.article(null,ShowInfo(this.props)))}}),datePattern=/^[^|]+/,Shows=React.createClass({displayName:"Shows",mixins:[PaginationMixin],getDefaultProps:function(){return{tz:"America/New_York",shows:[],pageSize:5}},render:function(){var t=moment().tz(this.props.tz),e=this.props.shows.slice(0);e.forEach(function(e){var a=datePattern.exec(e.when)[0].trim(),s=moment(a,"MMM DD, YYYY","en").tz(this.props.tz);s.locale(!1);var i=t.diff(s,"days");e.moment=s,e.daysAway=i,e.past=i>0},this),e.sort(function(t,e){if(!e.past&&!t.past){var a=e;e=t,t=a}var s=e.moment.diff(t.moment);return 0>s?-1:s>0?1:e.when<t.when?-1:e.when>t.when?1:e.url<t.url?-1:e.url>t.url?1:0});var a=!1,s=e.map(function(t,e){return 0!==e||t.past?t.past&&!a&&(a=!0,0!==e)?React.DOM.span({key:"past"},React.DOM.li(null,"Past shows..."),Show(t)):(t.key=t.url,Show(t)):React.DOM.span({key:"upcoming"},React.DOM.li(null,"Upcoming shows..."),Show(t))},this);return React.DOM.span(null,this.paginate(s),this.getPagination(s))}});module.exports=Shows;
},{"./pagination_mixin":3,"moment-timezone":7,"react":144}],5:[function(require,module,exports){
"use strict";function formatTime(t){var e=Math.floor(t/60),a=Math.ceil(t%60);return Number(e)+":"+(10>a?"0":"")+a}var React=require("react"),$=window.$,events=["ready","timeupdate","play","pause","ended"],SongPlayer=React.createClass({displayName:"SongPlayer",getDefaultProps:function(){return{siteUrl:"",playerId:"jPlayerWidget",tracks:[]}},getInitialState:function(){return{player:null,current:null}},componentDidMount:function(){var t=document.getElementById(this.props.playerId);t||(t=document.createElement("span"),t.id=this.props.playerId,document.body.appendChild(t));var e=$(t).jPlayer({swfPath:this.props.siteUrl+"asssets/js/vendor",supplied:"mp3",wmode:"window",volume:1});events.forEach(function(t){this["on_"+t]&&e.on("jPlayer_"+t+".jPlayer",this["on_"+t])}.bind(this)),this.setState({player:e})},componentWillUnmount:function(){var t=this.state.player;t&&events.forEach(function(e){this["on_"+e]&&t.off("jPlayer_"+e+".jPlayer",this["on_"+e])}.bind(this))},render:function(){var t=this.props.tracks.map(function(t){var e=[],a="",n="";return this.state.current===t?(e.push("current"),this.state.playing?(e.push("playing"),n="pause",a="ion-ios7-pause"):(n="resume",a="ion-ios7-play-outline")):(n="play",a="ion-ios7-play"),React.DOM.li({key:t.url,className:e.join(" ")},this.state.current===t?React.DOM.a({href:"#",onClick:function(t){t.preventDefault(),this.state.player.jPlayer("pause",0)}.bind(this)},React.DOM.i({className:"icon ion-ios7-skipbackward"})):React.DOM.i({className:"icon ion-ios7-musical-notes"}),React.DOM.a({href:"#",title:n,onClick:function(e){e.preventDefault(),this.click(t)}.bind(this)},React.DOM.i({className:"icon "+a})),React.DOM.span(null,t.title),this.state.current===t&&React.DOM.span({className:"time"}," ",formatTime(this.state.currentTime)+" of "+formatTime(this.state.duration)))}.bind(this));return React.DOM.ul({className:"post-list songs"},t)},click:function(t){this.state.current&&this.state.current===t?this.state.player.jPlayer(this.state.playing?"pause":"play"):this.state.player.jPlayer("setMedia",{mp3:window.encodeURI(t.url)}).jPlayer("play"),this.setState({current:t})},on_timeupdate:function(t){this.setState({currentTime:t.jPlayer.status.currentTime,duration:t.jPlayer.status.duration})},on_play:function(){this.setState({playing:!0}),"undefined"!=typeof window._gaq&&window._gaq.push(["_trackEvent","Songs","play",this.state.current.url])},on_pause:function(){this.setState({playing:!1}),"undefined"!=typeof window._gaq&&window._gaq.push(["_trackEvent","Songs","pause",this.state.current.url])},on_ended:function(){var t=this.state.current;this.setState({current:null,currentTime:null,duration:null});var e=this.props.tracks.indexOf(t);this.props.tracks.length&&e!==this.props.tracks.length-1&&(e=++e,this.click(this.props.tracks[e]))}});module.exports=SongPlayer;
},{"react":144}],6:[function(require,module,exports){
module.exports={
	"version": "2014e",
	"zones": [
...
},{"./invariant":121}],18:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./DOMProperty":17,"./escapeTextForBrowser":107,"./memoizeStringOnly":129,"./warning":143}],19:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":29,"./createNodesFromMarkup":102,"./emptyFunction":105,"./getMarkupWrap":114,"./invariant":121}],20:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":105}],25:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventPluginRegistry":26,"./EventPluginUtils":27,"./ExecutionEnvironment":29,"./accumulate":96,"./forEachAccumulated":110,"./invariant":121,"./isEventSupported":122,"./monitorCodeUse":134}],26:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],27:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":23,"./invariant":121}],28:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":23,"./EventPluginHub":25,"./accumulate":96,"./forEachAccumulated":110}],29:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactPropTypes":73,"./invariant":121,"./warning":143}],31:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],33:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactMount":64,"./invariant":121}],35:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./PooledClass":32,"./invariant":121,"./traverseAllChildren":142}],36:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactCurrentOwner":40,"./ReactOwner":68,"./ReactUpdates":80,"./invariant":121,"./keyMirror":127,"./merge":130,"./monitorCodeUse":134}],37:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactDOMIDOperations":45,"./ReactMarkupChecksum":63,"./ReactMount":64,"./ReactPerf":69,"./ReactReconcileTransaction":75,"./getReactRootElementInContainer":116,"./invariant":121}],38:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":36,"./ReactContext":39,"./ReactCurrentOwner":40,"./ReactErrorUtils":56,"./ReactOwner":68,"./ReactPerf":69,"./ReactPropTransferer":70,"./ReactPropTypeLocationNames":71,"./ReactPropTypeLocations":72,"./ReactUpdates":80,"./instantiateReactComponent":120,"./invariant":121,"./keyMirror":127,"./merge":130,"./mixInto":133,"./monitorCodeUse":134,"./objMap":135,"./shouldUpdateReactComponent":140,"./warning":143}],39:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":12,"./DOMProperty":17,"./DOMPropertyOperations":18,"./ReactBrowserComponentMixin":34,"./ReactComponent":36,"./ReactEventEmitter":57,"./ReactMount":64,"./ReactMultiChild":66,"./ReactPerf":69,"./escapeTextForBrowser":107,"./invariant":121,"./keyOf":128,"./merge":130,"./mixInto":133}],44:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./CSSPropertyOperations":12,"./DOMChildrenOperations":16,"./DOMPropertyOperations":18,"./ReactMount":64,"./ReactPerf":69,"./invariant":121}],46:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":10,"./DOMPropertyOperations":18,"./LinkedValueUtils":30,"./ReactBrowserComponentMixin":34,"./ReactCompositeComponent":38,"./ReactDOM":41,"./ReactMount":64,"./invariant":121,"./merge":130}],48:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactBrowserComponentMixin":34,"./ReactCompositeComponent":38,"./ReactDOM":41,"./warning":143}],49:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":10,"./LinkedValueUtils":30,"./ReactBrowserComponentMixin":34,"./ReactCompositeComponent":38,"./ReactDOM":41,"./invariant":121,"./merge":130}],50:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./AutoFocusMixin":10,"./DOMPropertyOperations":18,"./LinkedValueUtils":30,"./ReactBrowserComponentMixin":34,"./ReactCompositeComponent":38,"./ReactDOM":41,"./invariant":121,"./merge":130,"./warning":143}],52:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":23,"./EventListener":24,"./EventPluginHub":25,"./EventPluginRegistry":26,"./ExecutionEnvironment":29,"./ReactEventEmitterMixin":58,"./ViewportMetrics":95,"./invariant":121,"./isEventSupported":122,"./merge":130}],58:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactRootIndex":76,"./invariant":121}],63:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./DOMProperty":17,"./ReactEventEmitter":57,"./ReactInstanceHandles":62,"./ReactPerf":69,"./containsNode":98,"./getReactRootElementInContainer":116,"./instantiateReactComponent":120,"./invariant":121,"./shouldUpdateReactComponent":140}],65:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyObject":106,"./invariant":121}],69:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":105,"./invariant":121,"./joinClasses":126,"./merge":130}],71:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":36,"./ReactPropTypeLocationNames":71,"./createObjectFrom":103,"./warning":143}],74:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":36,"./ReactInstanceHandles":62,"./ReactMarkupChecksum":63,"./ReactServerRenderingTransaction":78,"./instantiateReactComponent":120,"./invariant":121}],78:[function(require,module,exports){
/**
...
},{"./ReactPerf":69,"./invariant":121}],81:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./EventConstants":23,"./EventPluginUtils":27,"./EventPropagators":28,"./SyntheticClipboardEvent":84,"./SyntheticDragEvent":86,"./SyntheticEvent":87,"./SyntheticFocusEvent":88,"./SyntheticKeyboardEvent":89,"./SyntheticMouseEvent":90,"./SyntheticTouchEvent":91,"./SyntheticUIEvent":92,"./SyntheticWheelEvent":93,"./invariant":121,"./keyOf":128}],84:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],95:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],97:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactCompositeComponent":38,"./invariant":121}],102:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":29,"./createArrayFrom":100,"./getMarkupWrap":114,"./invariant":121}],103:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121,"./traverseAllChildren":142}],109:[function(require,module,exports){
/**
 * Copyright 2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ExecutionEnvironment":29,"./invariant":121}],115:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./warning":143}],121:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],135:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactComponent":36,"./invariant":121}],138:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./invariant":121}],142:[function(require,module,exports){
/**
 * Copyright 2013-2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./ReactInstanceHandles":62,"./ReactTextComponent":79,"./invariant":121}],143:[function(require,module,exports){
/**
 * Copyright 2014 Facebook, Inc.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
},{"./emptyFunction":105}],144:[function(require,module,exports){
