...
"use strict";var moment=require("moment-timezone"),React=require("react"),PaginationMixin=require("./pagination_mixin"),ShowDetail=React.createClass({displayName:"ShowDetail",getDefaultProps:function(){return{}},render:function(){return React.DOM.div({className:"show-detail",dangerouslySetInnerHTML:{__html:this.props.content}})}}),ShowInfo=React.createClass({displayName:"ShowInfo",getDefaultProps:function(){return{}},render:function(){return React.DOM.span(null,this.props.title||this.props.venue," ",React.DOM.span({className:"show-date"},this.props.moment.format("dddd, MMMM D, YYYY"),this.props.time&&" | "+this.props.time),this.props.children)}}),Show=React.createClass({displayName:"Show",getInitialState:function(){return{detail:!1}},display:function(){var t=!this.state.detail;return this.setState({detail:t}),"undefined"!=typeof window._gaq&&window._gaq.push(["_trackEvent","Shows",t?"View Detail":"Hide Detail",this.props.url]),!1},render:function(){var t=!!String(this.props.content).trim();return t?React.DOM.li(null,React.DOM.article(null,React.DOM.a({href:this.props.url,onClick:this.display},ShowInfo(this.props,this.state.detail&&ShowDetail(this.props))))):React.DOM.li(null,React.DOM.article(null,ShowInfo(this.props)))}}),datePattern=/^[^|]+/,Shows=React.createClass({displayName:"Shows",mixins:[PaginationMixin],getDefaultProps:function(){return{tz:"America/New_York",shows:[],pageSize:5}},render:function(){var t=moment().tz(this.props.tz),e=this.props.shows.slice(0);e.forEach(function(e){var a=datePattern.exec(e.when)[0].trim(),n=moment(a,"MMM DD, YYYY","en").tz(this.props.tz);n.locale(!1);var i=t.diff(n,"days");e.moment=n,e.daysAway=i,e.past=i>0},this),e.sort(function(t,e){if(!e.past&&!t.past){var a=e;e=t,t=a}var n=e.moment.diff(t.moment);return 0>n?-1:n>0?1:e.when<t.when?-1:e.when>t.when?1:e.url<t.url?-1:e.url>t.url?1:0});var a=!1,n=e.map(function(t,e){return 0!==e||t.past?t.past&&!a&&(a=!0,0!==e)?React.DOM.span({key:"past"},React.DOM.li(null,"Past shows..."),Show(t)):(t.key=t.url,Show(t)):React.DOM.span({key:"upcoming"},React.DOM.li(null,"Upcoming shows..."),Show(t))},this);return React.DOM.span(null,this.paginate(n),this.getPagination(n))}});module.exports=Shows;
